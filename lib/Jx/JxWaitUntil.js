...
var JxWaitUntil = klass(function() {
	...
	activeElementHasProperty: function(property, value) {
		var element =  driver.buildDriver().property.TargetLocator.activeElement(),
			element = new PEWebElement(element);
		...
		property.timeout = JxTimeouts.default;
